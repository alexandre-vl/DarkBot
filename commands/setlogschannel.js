exports.run = (client, message, droit) => {
    ...
    srv.set(`${message.guild.id}`, channel, "logschannel");
    srv.set(`${message.guild.id}`, "on", "statlogs");
    const embed = new Discord.MessageEmbed()
        .setColor(client.config.green)
        .setDescription("<a:checkmarkmoove:740634693078089730> Le channel des logs est défini : " + channel);
